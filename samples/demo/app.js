  ...
  $(document).ready(function () {
    $('#network').chainNetwork({
      ...
      nodes: [
        ...
        { id: 'user_7', label: 'user', group: 'user' },
        { id: 'user_8', label: 'user', group: 'user' },
        { id: 'user_9', label: 'user', group: 'user' },
        { id: 'user_10', label: 'user', group: 'user' },
        { id: 'user_11', label: 'user', group: 'user' },
        { id: 'user_12', label: 'user', group: 'user' },
        { id: 'user_13', label: 'user', group: 'user' },
        { id: 'user_14', label: 'user', group: 'user' },
        { id: 'user_15', label: 'user', group: 'user' },
        { id: 'user_16', label: 'user', group: 'user' },
